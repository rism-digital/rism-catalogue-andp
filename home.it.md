...
Le composizioni di Pollini sono state ordinate in sette sezioni, contraddistinte da lettere dell’alfabeto (A-G), seguite da un numero progressivo. La prima sezione (A) elenca le opere per pianoforte, la seconda (B) le opere strumentali per altro organico. La musica vocale comprende le sezioni C, per la musica vocale da camera, D, per il teatro musicale, ed E, per la musica sacra. La sezione F, con le opere pedagogiche, è numericamente la più breve ma tra le più importanti per la ricezione del compositore. Infine, un’appendice (sezione G) contiene le opere perdute e le riduzioni per canto e piano redatte da Pollini di opere altrui.  
...
Il catalogo tematico di Francesco Pollini (Francesco Pollini Catalogue / AndP) è pubblicato dalla Accademia delle Arti di Berna [HKB](https://www.hkb-interpretation.ch/francescopollini) e dal [RISM Digital Center](https://catalogue.rism.digital/AndP).
...
Il catalogo tematico di Francesco Pollini (Francesco Pollini Catalogue / AndP) è pubblicato dalla Accademia delle Arti di Berna [HKB](https://www.hkb-interpretation.ch/francescopollini) e dal [RISM Digital Center](https://catalogue.rism.digital/AndP).
>>>>>>> c50ad0a47818a4218536e65243d00f9f22d17aef
